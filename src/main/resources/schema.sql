DROP TABLE IF EXISTS comments, item_requests, bookings, items, users;
...
(
    item_requests_id           BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    description  VARCHAR(4000)                           NOT NULL,
    requester_user_id BIGINT,
    created      TIMESTAMP WITHOUT TIME ZONE             NOT NULL,
    CONSTRAINT pk_item_request PRIMARY KEY (item_requests_id),
...
(
    ...
    CONSTRAINT FK_ITEM_ON_REQUEST FOREIGN KEY (request_id) REFERENCES item_requests (item_requests_id),
    CONSTRAINT UQ_OWNER_ITEM_NAME UNIQUE (owner_user_id, name)
);
